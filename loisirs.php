...
<div class="container-fluid p-0">
          <div class="site-slider">
            <div class="slider-one">
              <div>
                <img src="Party1.jpg" class="img-fluid" style="margin-left:auto; margin-right:auto; display:block;" alt="Test 1">
              </div>
              <div>
                <img src="Party2.jpg" class="img-fluid" style="margin-left:auto; margin-right:auto; display:block;" alt="Test 2">
              </div>
              <div>
                <img src="Party3.jpg" class="img-fluid" style="margin-left:auto; margin-right:auto; display:block;" alt="Test 3">
              </div>
            </div>
 ...
 <!-- Product Product  Product  Product  Product  Product  Product  Product  Product  Product  Product  Product  Product  Product  Product  Product  Product   -->
			...
			<section class="grido">
				...
				<div class="product">
					<div class="product__info">
                        <div>
                                <img class="product__image" src="11m.png" alt="Product 1" />
				...
				<div class="product">
					<div class=" product__info">
                        <div>
                            <img class="product__image" src="11m.png" alt="Product 2" />
				...
				<div class="product">
					<div class="product__info">
                        <div>
                            <img class="product__image" src="11m.png" alt="Product 3" />
				...
				<div class="product">
					<div class="product__info">
                        <div>
                        <img class="product__image" src="11m.png" alt="Product 4" />
				...
				<div class="product">
					<div class="product__info">
                        <div>
                        <img class="product__image" src="11m.png" alt="Product 5" />
				...
				<div class="product">
					<div class="product__info">
                        <div>
                        <img class="product__image" src="11m.png" alt="Product 6" />
				...
				<div class="product">
					<div class="product__info">
                        <div>
                        <img class="product__image" src="11m.png" alt="Product 7" />
				...
				<div class="product">
					<div class="product__info">
                        <div>
                        <img class="product__image" src="11m.png" alt="Product 8" />
				...
				<div class="product">
					<div class="product__info">
                        <div>
                        <img class="product__image" src="11m.png" alt="Product 9" />
				...
				<div class="product">
					<div class="product__info">
                        <div>
                        <img class="product__image" src="11m.png" alt="Product 10" />
				...
				<div class="product">
					<div class="product__info">
                        <div>
                        <img class="product__image" src="11m.png" alt="Product 11" />
				...
				<div class="product">
					<div class="product__info">
                        <div>
                        <img class="product__image" src="11m.png" alt="Product 12" />
        ...
        <form action="loisirs.php" method="POST">
                                <div class="devis" style="border: solid; padding: 30px; border-radius: 15px;">
                                    ...
                                    <h3 class="text-danger">Votre Devis Personnalisé - Pour LOISIRS</h3>
                                    ...
                                    <div class="row">
                                        <div style="border-right: solid;border-color: lightgrey" class="col-lg-4">
                                            ...
                                            <div class="form-group">
                                                <span style="color: red">*</span> <label for="exampleInputPassword1">Date de la fête</label>
                                                <input type="date" class="form-control" name="datedefete" id="exampleInputPassword1">
                                            </div>
                                        </div>
                                        ...
                                        <div style="border-right: solid;border-color: lightgrey" class="col-lg-4 ">
                                            ...
                                            <div class="form-group">
                                                <label for="exampleFormControlSelect1">Votre budget</label>
