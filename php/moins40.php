...
<body class="bodynewnav">
    ...
    ?>
    <h2 style="text-align:center; font-family:Fredericka the Great;">Moins de 40 Euros</h2>
    <hr>
            ...
            <h4>Price</h4>
                ...
                <div class="list-group">
                    ...
                    <?php
                      ...
                      {if($row['chateau'] != "Domaine d'Arpaillan" && $row['chateau'] != "Domaine de Brondeau Lalande")
                        {
                      ?>
                ...
                <div class="list-group">
                    ...
                    $result=$statement->fetchAll();
                    foreach($result as $row)
                    {if($row['pro_nom'] != "LAVALETTE CUVÉE PRESTIGE" && $row['pro_nom'] != "LAVALETTE" && $row['pro_nom'] != "LA POMMERAIE" && $row['pro_nom'] != "LARTENAC CUVÉE" && $row['pro_nom'] != "TOUR D'ARPAILLAN CUVÉE PRESTIGE" && $row['pro_nom'] != "TOUR D'ARPAILLAN" && $row['pro_nom'] != "BRONDEAU LALANDE 2018" && $row['pro_nom'] != "BRONDEAU LALANDE 2017" && $row['pro_nom'] != "BRONDEAU LALANDE 2010")
                        {
                    ?>
                    <div class="list-group-item checkbox" style="color:#820000;">
