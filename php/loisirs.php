...
<div class="container-fluid p-0">
          <div class="site-slider">
            <div class="slider-one">
              <div>
                <img src="images/Event/Party1.jpg" class="img-fluid" style="margin-left:auto; margin-right:auto; display:block;" alt="Test 1">
              </div>
              <div>
                <img src="images/Event/Party2.jpg" class="img-fluid" style="margin-left:auto; margin-right:auto; display:block;" alt="Test 2">
              </div>
              <div>
                <img src="images/Event/Party3.jpg" class="img-fluid" style="margin-left:auto; margin-right:auto; display:block;" alt="Test 3">
              </div>
            </div>
...
if (isset($_POST['envoyer'])) {
    ...
    $sql = $dbh->prepare("Insert into devis2(
nom,
prenom,
telephone,
email,
...
values(:nom,:prenom,:telephone,:email,:datedefete,:departement,:votrebudget,:nombredadultes,:decrivezvosbesoins,:mecontacterpar,:pourlevindhonneur,:pourlerepas,:pourledessert)");
    $sql->execute(array(
        ':nom' => $Nom,
        ':prenom' => $Prenom,
        ':telephone' => $Telephone,
        ':email' => $Email,
        ':datedefete' => $Datedefete,
...
} elseif ($Nom = "" || $Prenom = "" || $Telephone = "" || $datedefete = "" || $Departement = "" || $Votrebudget = "" || $Nombredadultes = "" || $Decrivezvosbesoins = "" || $Mecontacterpar = "" || $Pourlevindhonneur = "" || $Pourlerepas = "" || $Pourledessert = "") {
