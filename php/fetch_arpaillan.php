...
if(isset($_POST["action"]))
{
    ...
    if($total_row > 0)
    {
        ...
        {
            if($row['pro_nom'] == 'LARTENAC CUVÉE' || $row['pro_nom'] == 'LAVALETTE CUVÉE PRESTIGE' || $row['pro_nom'] == 'LAVALETTE' || $row['pro_nom'] == 'LA POMMERAIE' || $row['pro_nom'] == "TOUR D'ARPAILLAN" || $row['pro_nom'] == "TOUR D'ARPAILLAN CUVÉE PRESTIGE")
            ...
            <form method="POST" action="panier.php?action=add&id='.$row['id'].'; ?>">
                            ...
                            <div style="text-align: center">
                                ...
                                <span class="product_price highlight">'.$row['pro_prix'].'€</span><br>
                                Année : '.$row['date'].'<br>
