                ...
                <ul class="nav-list">
                   <li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                                                <li>
                                                    <a href="php/Arpaillan.php">Arpaillan</a>
                                                </li>
                                                <li>
                                                    <a href="php/Brondeau.php">Brondeau Lalande</a>
                                                </li>
                        </ul> 
                    </li>
...
" Rendre la qualité des plus grands vins accessible au plus grand nombre "</h1>
      ...
      <div class="container-fluid p-0">
          <div class="site-slider">
            <div class="slider-one">
              <div>
                <img src="1.jpg" class="img-fluid" style="margin-left:auto; margin-right:auto; display:block;" alt="Test 1">
              </div>
              <div>
                <img src="2.jpg" class="img-fluid" style="margin-left:auto; margin-right:auto; display:block;" alt="Test 2">
              </div>
              <div>
                <img src="3.jpg" class="img-fluid" style="margin-left:auto; margin-right:auto; display:block;" alt="Test 3">
              </div>
            </div>
        ...
        <div class="site-slider-two px-md-4">
          <div class="row slider-two text-center">
            <div class="col-md-2 product pt-md-5 pt-4">
              <img src="Chateau-Bahans.jpg" class="img-fluid" alt="Product 1" />
              <span class="border site-btn btn-span">Bahans</span>
            </div>
            <div class="col-md-2 product pt-md-5 pt-4">
              <img src="Chateau-Brane.jpg" class="img-fluid" alt="Product 2" />
              <span class="border site-btn btn-span">Brane</span>
            </div>

            <div class="col-md-2 product pt-md-5 pt-4">
              <img src="Pavillon-Rouge.jpg" class="img-fluid" alt="Product 4" />
              <span class="border site-btn btn-span">P.Rouge</span>
            </div>
            <div class="col-md-2 product pt-md-5 pt-4">
              <img src="Chateau-Talbot.jpg" class="img-fluid" alt="Product 3" />
              <span class="border site-btn btn-span">Talbot</span>
            </div>
            <div class="col-md-2 product pt-md-5 pt-4">
              <img src="Chateau-Lynch.jpg" class="img-fluid" alt="Product 5" />
              <span class="border site-btn btn-span">Lynch</span>
            </div>
            <div class="col-md-2 product pt-md-5 pt-4">
              <img src="Chateau-Latour.jpg" class="img-fluid" alt="Product 3" />
  ...
  <hr class="hr"/>
    ...
    <div class="container-fluid">
        <div class="site-slider-three px-md-4">
          <div class="slider-three row text-center px-4">
            ...
            <div class="col-md-2 product pt-md-5">
              <img src="Chateau-Chatelet.jpg" class="img-fluid" alt="Image 1">
          ...
          <!--2nd Product-->
          <div class="col-md-2 product pt-md-5">
            <img src="Chateau-Latour.jpg" class="img-fluid" alt="Image 2">
            <div class="cart-details">
            ...
            <!--3rd Product-->
            <div class="col-md-2 product pt-md-5">
              <img src="Chateau-Lynch.jpg" class="img-fluid" alt="Image 3">
              <div class="cart-details">
          ...
          <!--4st Product-->
          <div class="col-md-2 product pt-md-5">
            <img src="Chateau-Mejean.jpg" class="img-fluid" alt="Image 4">
            <div class="cart-details">
        ...
        <!--5st Product-->
        <div class="col-md-2 product pt-md-5">
          <img src="La-Garde.jpg" class="img-fluid" alt="Image 4">
          <div class="cart-details">
      ...
      <!--6st Product-->
      <div class="col-md-2 product pt-md-5">
        <img src="La-Garde.jpg" class="img-fluid" alt="Image 5">
        <div class="cart-details">
    ...
    <div class="container">
      <div class="row">
       <div class="col">
         <img src="8.jpg" alt="Wine" class="img-fluid">
        </div> 
      </div> 
    </div>
...
<br><hr>
    ...
    <div class="container-fluid">
      <div class="site-slider-four px-md-4">
          <div class="slider-four row text-center">
              <div class="col-md-2 product pt-md-5">
                <img src="Arpaillan.jpg" class="border img-fluid" style=" border-radius: 50%; margin:auto;" alt="Chateau 1" title="Domain d'Arpaillan">
              </div>
              <div class="col-md-2 product pt-md-5">
                <img src="Darpaillan.jpg" class="border img-fluid" style=" border-radius: 50%; margin:auto;" alt="Chateau 2" title="Domain d'Arpaillan">
              </div>
              <div class="col-md-2 product pt-md-5">
                <img src="VinArpaillan.jpg" class="border img-fluid" style=" border-radius: 50%; margin:auto;" alt="Chateau 3" title="Domain d'Arpaillan">
              </div>
              <div class="col-md-2 product pt-md-5">
                <img src="BrondeauLalande.jpg" class="border img-fluid" style=" border-radius: 50%; margin:auto;" alt="Chateau 4" title="Domaine de Brondeau Lalande">
              </div>
              <div class="col-md-2 product pt-md-5">
                <img src="Brondeau.jpg" class="border img-fluid" style=" border-radius: 50%; margin:auto;" alt="Chateau 5" title="Domaine de Brondeau Lalande">
              </div>
              <!--<div class="col-md-2 product pt-md-5">
                <img src="Saint-Julien.jpg" class="border img-fluid" style=" border-radius: 50%; margin:auto;" alt="Chateau 6" title="Château Saint-Julien">
              </div>-->
              <div class="col-md-2 product pt-md-5">
                <img src="Brondeau2.jpg" class="border img-fluid" style=" border-radius: 50%; margin:auto;" alt="Chateau 7" title="Domaine de Brondeau Lalande">
              </div>
          </div>
          <!-- Flash -->
          <div class="slider-btn">
    ...
    <div class="container my-5 banner">
          <div class="col-md-8 col-12">
            <img src="banner3.jpg" class="img-fluid" alt="Banner 3">
          </div>
          
          <div class="col-md-4 col-12">
            <img src="banner2.jpg" class="img-fluid" alt="Banner 2">
          </div>
    </div>
    <!--/Banner-->
  ...
  <div class="column items">
    ...
    <div class="photo-items">
      <img src="Chateau-Lartenac.jpg" alt="Product 1" width="100px" height="100px">
      <span>Château Lartenac</span>
    </div>
    <div class="photo-items">
      <img src="Chateau-Lavalette-Prestige.jpg" alt="Product 2" width="100px" height="100px">
      <span>Château Lavalette Cuvée Prestige</span>

    </div>
    <div class="photo-items">
      <img src="Chateau-La-Pommeraie.jpg" alt="Product 3" width="100px" height="100px">
  ...
  <a href="brondeau.php" style="text-decoration:none; color:black;"><h4 style="font-family: Fredericka the Great; ">Domaine de Brondeau Lalande</h4></a>
    <div class="photo-items">
      <img src="Lalande.jpg" alt="Product 1" width="100px" height="100px">
      <span>Château Brondeau Lalande (2018)</span>
    </div>
    <div class="photo-items">
      <img src="Lalande.jpg" alt="Product 2" width="100px" height="100px">
      <span>Château Brondeau Lalande (2017)</span>
    </div>
    <div class="photo-items">
      <img src="Lalande.jpg" alt="Product 3" width="100px" height="100px">
    ...
    <div class="container-fluid">
      <div class="slider-brand">
        <div class="slider-five px-5">
          <div>
            <img src="Cos.jpg" alt="Brand 1" class="img-fluid" style="margin:auto;">
          </div>
          <div>
            <img src="Giscours.jpg" alt="Brand 2" class="img-fluid" style="margin:auto;">
          </div>
          <div>
            <img src="Lynch-Bages.jpg" alt="Brand 3" class="img-fluid" style="margin:auto;">
          </div>
          <div>
            <img src="Malartic.jpg" alt="Brand 4" class="img-fluid" style="margin:auto;">
          </div>
          <div>
            <img src="Margaux.jpg" alt="Brand 5" class="img-fluid" style="margin:auto;">
          </div>
          <div>
            <img src="Pontet-Canet.jpg" alt="Brand 6" class="img-fluid" style="margin:auto;">
          </div>
          <div>
            <img src="Talbot.jpg" alt="Brand 7" class="img-fluid" style="margin:auto;">
          </div>
        </div>
        <!-- Flash -->
        <div class="slider-btn">
...
<div class="row" style="margin:auto;">
    <div class="container text-center">
        <p class="pt-5">
          <img src="payment.png" alt="payment image" class="img-fluid">
        </p>
